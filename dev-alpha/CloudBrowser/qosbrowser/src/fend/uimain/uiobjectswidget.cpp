...
UiObjectsWidget::UiObjectsWidget(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::UiObjectsWidget)
{
    ui->setupUi(this);
    ui->tableView->setModel(MG->mModels->modelBuckets());                   // 设置视图(表)内容
...
UiObjectsWidget::~UiObjectsWidget()
{
    delete ui;
}
